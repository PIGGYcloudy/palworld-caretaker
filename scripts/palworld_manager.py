...
DEFAULT_CONFIG: dict[str, str] = {
    ...
    "PAL_STAMINA_DECREACE_RATE": "1.0", "PLAYER_STAMINA_DECREACE_RATE": "1.0",
    "PAL_AUTO_HP_REGENE_RATE": "1.0", "PLAYER_AUTO_HP_REGENE_RATE": "1.0",
    "PAL_AUTO_HP_REGENE_RATE_IN_SLEEP": "1.0", "PLAYER_AUTO_HP_REGENE_RATE_IN_SLEEP": "1.0",
    "PAL_STOMACH_DECREACE_RATE": "1.0", "PLAYER_STOMACH_DECREACE_RATE": "1.0",
    "GUILD_PLAYER_MAX_NUM": "20", "PAL_SPAWN_NUM_RATE": "1.0",
    "DROP_ITEM_MAX_NUM": "3000", "PAL_EGG_DEFAULT_HATCHING_TIME": "72.0",
    "DROP_ITEM_ALIVE_MAX_HOURS": "1.0", "BASE_CAMP_WORKER_MAX_NUM": "15",
    "WORK_SPEED_RATE": "1.0", "ITEM_WEIGHT_RATE": "1.0",
    "EQUIPMENT_DURABILITY_DAMAGE_RATE": "1.0", "DEATH_PENALTY": "Item",
    "BUILD_OBJECT_HP_RATE": "1.0", "BUILD_OBJECT_DAMAGE_RATE": "1.0",
...
EDITABLE_SETTING_KEYS = frozenset({
    ...
    "PAL_STAMINA_DECREACE_RATE", "PLAYER_STAMINA_DECREACE_RATE",
    "PAL_AUTO_HP_REGENE_RATE", "PLAYER_AUTO_HP_REGENE_RATE",
    "PAL_AUTO_HP_REGENE_RATE_IN_SLEEP", "PLAYER_AUTO_HP_REGENE_RATE_IN_SLEEP",
    "PAL_STOMACH_DECREACE_RATE", "PLAYER_STOMACH_DECREACE_RATE",
    "GUILD_PLAYER_MAX_NUM", "BASE_CAMP_MAX_NUM_IN_GUILD",
    "PAL_SPAWN_NUM_RATE", "DROP_ITEM_MAX_NUM",
    "DROP_ITEM_ALIVE_MAX_HOURS", "PAL_EGG_DEFAULT_HATCHING_TIME",
    "BASE_CAMP_WORKER_MAX_NUM", "WORK_SPEED_RATE", "ITEM_WEIGHT_RATE",
...
def validate_config(config: dict[str, str]) -> dict[str, Path | None]:
    ...
    env_int(config, "BASE_CAMP_WORKER_MAX_NUM", 15, 1, 50)
    for key, minimum, maximum in (
        ...
        ("PAL_STAMINA_DECREACE_RATE", .1, 5), ("PLAYER_STAMINA_DECREACE_RATE", .1, 5),
        ("PAL_AUTO_HP_REGENE_RATE", .1, 5), ("PLAYER_AUTO_HP_REGENE_RATE", .1, 5),
        ("PAL_AUTO_HP_REGENE_RATE_IN_SLEEP", .1, 5), ("PLAYER_AUTO_HP_REGENE_RATE_IN_SLEEP", .1, 5),
        ("PAL_STOMACH_DECREACE_RATE", .1, 5), ("PLAYER_STOMACH_DECREACE_RATE", .1, 5),
        ("PAL_SPAWN_NUM_RATE", .1, 5), ("DROP_ITEM_ALIVE_MAX_HOURS", .1, 8760),
        ("PAL_EGG_DEFAULT_HATCHING_TIME", 0, 240), ("WORK_SPEED_RATE", .1, 5),
        ("ITEM_WEIGHT_RATE", .1, 5), ("EQUIPMENT_DURABILITY_DAMAGE_RATE", .1, 5),
        ("BUILD_OBJECT_HP_RATE", .1, 5), ("BUILD_OBJECT_DAMAGE_RATE", .1, 5),
        ("BUILD_OBJECT_DETERIORATION_DAMAGE_RATE", 0, 5),
    ):
    ...
    env_int(config, "PALWORLD_MEMORY_ALERT_PERCENT", 85, 10, 99)
    env_int(config, "PALWORLD_MEMORY_ALERT_COOLDOWN_SECONDS", 1800, 60, 86400)
