...
</style></head><body><div class=\"app-shell\"><header class=\"topbar\"><div class=\"brand\"><div class=\"brand-mark\" aria-hidden=\"true\">◆</div><div><h1>Palworld Caretaker</h1><p class=\"eyebrow\">你的伺服器控制台</p></div></div><nav aria-label=\"頁面導覽\"><a href=\"#overview\">總覽</a><a href=\"#operations\">維護</a><a href=\"#world-settings\">世界設定</a><a href=\"#integrations\">整合</a></nav></header><main><p class=\"eyebrow muted\">受認證的管理介面；請只透過受信任的本機、LAN 或 VPN 網路使用。</p>
